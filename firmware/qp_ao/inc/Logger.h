//.$file${Logging::../inc::Logger.h} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
//
// Model: PFPP.qm
...
public:
    ...
    LogLevel::prio GetLogLevel(void) const;
    LogLevel::prio GetLogLevel(char const * const aCategoryStr) const;
    unsigned int GetEventSignal(char const * const aCategoryStr) const;

    void SetLogLevel(LogLevel::prio const aLevel);
    bool AddCategory(
...
private:
    ...
    void *operator new([[maybe_unused]] size_t aSize){ return &(Instance()); }
    void  operator delete([[maybe_unused]] void *aLogger) {}
